...
\input{src/section1/introductionGraphics.tex}
\subsection{Типы компьютерной графики}
\input{src/section1/typesOfGraphics.tex}
\subsection{Математические основы}
\input{src/section1/mathFound.tex}
\subsection{Этапы рендеринга}
\input{src/section1/rendering.tex}
...
\input{src/section3/graphicsAlg.tex}
\subsection{Оптимизация графики}
\input{src/section3/fps.tex}
...
\input{src/section1/appendix1.tex}
\newpage

\section{}

\input{src/section2/appendix2.tex}
